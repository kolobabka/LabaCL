...
/**
 ** \file /home/kolobabka/Desktop/LabaCL/build/grammar.tab.hh
...
#ifndef YY_YY_HOME_KOLOBABKA_DESKTOP_LABACL_BUILD_GRAMMAR_TAB_HH_INCLUDED
# define YY_YY_HOME_KOLOBABKA_DESKTOP_LABACL_BUILD_GRAMMAR_TAB_HH_INCLUDED
// "%code requires" blocks.
#line 10 "frontend/parser/grammar.y"
...
#line 59 "/home/kolobabka/Desktop/LabaCL/build/grammar.tab.hh"
...
namespace yy {
#line 194 "/home/kolobabka/Desktop/LabaCL/build/grammar.tab.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // exprList
      // expA
      char dummy4[sizeof (std::vector<AST::Node*>*)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_translationStart = 40,                 // translationStart
        S_statementHandler = 41,                 // statementHandler
        S_statement = 42,                        // statement
        S_returnStatement = 43,                  // returnStatement
        S_printStatement = 44,                   // printStatement
        S_argsList = 45,                         // argsList
        S_args = 46,                             // args
        S_exprList = 47,                         // exprList
        S_expA = 48,                             // expA
        S_ifStatement = 49,                      // ifStatement
        S_whileStatement = 50,                   // whileStatement
        S_conditionExpression = 51,              // conditionExpression
        S_body = 52,                             // body
        S_assignment = 53,                       // assignment
        S_func = 54,                             // func
        S_assignStatement = 55,                  // assignStatement
        S_orStatement = 56,                      // orStatement
        S_andStatement = 57,                     // andStatement
        S_eqStatement = 58,                      // eqStatement
        S_cmpStatement = 59,                     // cmpStatement
        S_addStatement = 60,                     // addStatement
        S_mulStatement = 61,                     // mulStatement
        S_unaryStatement = 62,                   // unaryStatement
        S_term = 63,                             // term
        S_atomic = 64                            // atomic
      };
    };
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, AST::Node*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<AST::Node*>*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<AST::Node*>*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    ...
    parser (yy::FrontendDriver* driver_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_OPCIRCBRACK (location_type l)
      {
        return symbol_type (token::OPCIRCBRACK, std::move (l));
      }
#else
      static
      symbol_type
      make_OPCIRCBRACK (const location_type& l)
      {
        return symbol_type (token::OPCIRCBRACK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLCIRCBRACK (location_type l)
      {
        return symbol_type (token::CLCIRCBRACK, std::move (l));
      }
#else
      static
      symbol_type
      make_CLCIRCBRACK (const location_type& l)
      {
        return symbol_type (token::CLCIRCBRACK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPCURVBRACK (location_type l)
      {
        return symbol_type (token::OPCURVBRACK, std::move (l));
      }
#else
      static
      symbol_type
      make_OPCURVBRACK (const location_type& l)
      {
        return symbol_type (token::OPCURVBRACK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLCURVBRACK (location_type l)
      {
        return symbol_type (token::CLCURVBRACK, std::move (l));
      }
#else
      static
      symbol_type
      make_CLCURVBRACK (const location_type& l)
      {
        return symbol_type (token::CLCURVBRACK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_FUNC_DECL (location_type l)
      {
        return symbol_type (token::FUNC_DECL, std::move (l));
      }
#else
      static
      symbol_type
      make_FUNC_DECL (const location_type& l)
      {
        return symbol_type (token::FUNC_DECL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LEXERR (location_type l)
      {
        return symbol_type (token::LEXERR, std::move (l));
      }
#else
      static
      symbol_type
      make_LEXERR (const location_type& l)
      {
        return symbol_type (token::LEXERR, l);
      }
#endif
...
#line 1778 "/home/kolobabka/Desktop/LabaCL/build/grammar.tab.hh"




#endif // !YY_YY_HOME_KOLOBABKA_DESKTOP_LABACL_BUILD_GRAMMAR_TAB_HH_INCLUDED
