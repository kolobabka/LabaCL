...
namespace yy {
    ...
    public:
        ...
        /*
        1. О чем / Какие боли решает
        2. Аналоги / преимущества
        3. Реализация (языки программирования, библиотеки и т.д.)
        4. Структуру проекта
        5. Демонстрация
        6. От каждого участника должен быть кусок реализации (его презентация этой части)
        7. Уникальнейшие куски кода могут быть на презентации
        8. Дальнейшие планы?
        */
